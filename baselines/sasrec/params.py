...
def parse_args():
    ...
    parser.add_argument('--save_path', default='tmp', type=str, help='save model')
    parser.add_argument('--load_model', default=None, type=str, help='load from saved model')
    parser.add_argument('--shoot', default=10, type=int, help='K for top-K metrics')
    parser.add_argument('--data', default='yelp', type=str, help='name of dataset')

    parser.add_argument('--num_his', default=20, type=int, help='max number of history interactions')
    parser.add_argument('--num_layers', default=2, type=int, help='number of attention&feedforward layers')
    parser.add_argument('--num_heads', default=4, type=int, help='number of attention&feedforward layers')
    parser.add_argument('--dropout', default=0.2, type=float, help='rate of dropout')
